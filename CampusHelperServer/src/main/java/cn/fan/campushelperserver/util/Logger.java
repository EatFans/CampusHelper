package cn.fan.campushelperserver.util;
...
public class Logger {
    ...
    public static void info(String message) {
        System.out.println(getLogFormat("INFO", message));
    }

    public static void warning(String message) {
        System.out.println(getLogFormat("WARN", message));
    }

    public static void error(String message) {
        System.out.println(getLogFormat("ERROR", message));
    }
    ...
    public static void info(String message, Class<?> c) {
        System.out.println(getLogFormat("INFO", c, message));
    }

    public static void warning(String message, Class<?> c) {
        System.out.println(getLogFormat("WARN", c, message));
    }

    public static void error(String message, Class<?> c) {
        System.out.println(getLogFormat("ERROR", c, message));
    }
}
